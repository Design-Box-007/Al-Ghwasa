...
const GastecSecondSection = () => {
    return (
        <section className="px-4 sm:px-6 space-y-10 py-12">
            <RevealComponent direction='bottom' backgroundClass='bg-white' outerClass="space-y-6">
            ...
            <RevealComponent direction='bottom' outerClass="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
