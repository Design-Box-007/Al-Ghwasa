...
const MX3Hero = () => {
    return (
        <header className="py-4 min-h-screen lg:min-h-[700px] lg:h-[800px] w-full bg-white pb-30">
            <div className="h-full flex flex-col lg:flex-row items-center justify-center p-6 md:p-c-20 relative overflow-hidden rounded-[20px]">
                ...
                <Image
                    ...
                    width={1360}
                    height={683}
                    className="absolute inset-0 z-10 object-cover object-center rounded-[20px] brightness-90"
                />

                {/* Hero Content */}
                <div className="relative z-20 text-white w-full space-y-6">
                    <h1 className='text-[84px] font-medium text-center'>
