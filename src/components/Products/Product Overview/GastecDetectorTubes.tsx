...
const GastecDetectorTubes: React.FC = () => {
  return (
    <ProductGrid
      title="GASTEC Detector Tubes"
      subtitle="Measure over 500 gases and vapors with unmatched accuracy using GASTEC’s industry-leading detector tubes."
      items={tubes}
      ctaLabel="View Tubes"
      ctaHref="#"
      actionVariant="arrow"
...
export default GastecDetectorTubes;
