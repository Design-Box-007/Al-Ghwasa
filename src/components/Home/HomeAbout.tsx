  ...
  return (
    <section className="space-y-4 p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-2">
        ...
        >
          Over 30 Years of <br />
          Excellence in industrial and marine
        </RevealComponent>
        <div className="flex flex-col gap-14 justify-around flex-1 lg:px-2">
          <RevealComponent outerClass="space-y-5" direction="bottom">
          ...
          <RevealComponent outerClass="flex flex-row justify-between py-2 border-b border-b-custom-red-light">
            <Link
              href="/about"
              passHref
