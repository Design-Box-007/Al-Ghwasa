            ...
            <div className="w-full px-4 md:px-8 lg:px-16">
                ...
                <div className="text-center mb-12">
                    <h2 className="text-5xl md:text-6xl font-bold text-black mb-4">
                        Why Professionals Rely on Al Ghwasa
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="bg-gray-100 p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-300 min-h-[320px] md:min-h-[360px] flex flex-col justify-center"
                        >
