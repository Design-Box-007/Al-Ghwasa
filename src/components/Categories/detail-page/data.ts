export const features = [
  ...
  { title: "Durable Design", description: "Built for rugged industrial use." },
  {
...
export const specifications = [
  ...
  {
    title: "Power Source",
    description: "Two AA alkaline batteries (LR6 Panasonic / MN1500 Duracell)",
  },
  { title: "Battery Life", description: "3 months (*with normal operation)" },
  {
...
export const relatedProduct = [
  {
    imgSrc: "/images/Gastec3/gas-detection-specialized-sampling-kits/GHS_8AT_EX_5.jpg",
    name: "GHS-8AT EX Starter Kit",
    description: "Maintains consistent pressure for reliable results.",
  },
  {
    imgSrc: "/images/Gastec3/gas-detection-specialized-sampling-kits/GHS_501FT_3.jpg",
